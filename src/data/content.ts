...
const data: Record<Language, SiteData> = {
  fr: {
    ...
    products: [
      ...
      { id: "pao-237", name: "Pão 237", description: "Soft inside. Melted cheese.", image: "", category: "Classiques" },
      { id: "empada-237", name: "237 Empada", description: "Rich filling. Golden crust.", image: "", category: "Classiques" },
  ...
  en: {
    ...
    products: [
      ...
      { id: "urban-kibe", name: "Urban Kibe", description: "Bold flavor. Perfect crunch.", image: "", category: "Signature" },
      { id: "rua-rissois", name: "Rua Rissois", description: "Swiss meat. Street crisp format.", image: "", category: "Signature" },
      { id: "pao-237", name: "Pão 237", description: "Soft inside. Melted cheese.", image: "", category: "Classics" },
      { id: "empada-237", name: "237 Empada", description: "Rich filling. Golden crust.", image: "", category: "Classics" },
  ...
  pt: {
    ...
    products: [
      ...
      { id: "empada-237", name: "237 Empada", description: "Recheio rico. Massa dourada.", image: "", category: "Clássicos" },
