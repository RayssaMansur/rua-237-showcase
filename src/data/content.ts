...
const data: Record<Language, SiteData> = {
  fr: {
    ...
    products: [
      ...
      { id: "empada-237-ltd", name: "237 Empada", description: "Chicken empada. Classic recipe.", image: "", category: "Limited Drops" },
      { id: "pao-237-ltd", name: "Pão 237", description: "Traditional cheese bread.", image: "", category: "Limited Drops" },
      { id: "bacalhau-drop-ltd", name: "Bacalhau Drop", description: "Codfish fritter. Crisp and golden.", image: "", category: "Limited Drops" },
  ...
  pt: {
    ...
    limitedDrops: [
      { id: "empada-237-ltd", name: "237 Empada", description: "Empada de frango. Receita cl\u00e1ssica.", image: "", category: "Limited Drops" },
      { id: "pao-237-ltd", name: "P\u00e3o 237", description: "P\u00e3o de queijo tradicional.", image: "", category: "Limited Drops" },
      { id: "bacalhau-drop-ltd", name: "Bacalhau Drop", description: "Bolinho de bacalhau. Crocante e dourado.", image: "", category: "Limited Drops" },
