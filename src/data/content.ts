...
const data: Record<Language, SiteData> = {
  fr: {
    ...
    products: [
      ...
      { id: "rua-rissois", name: "Rua Rissois", description: "Viande suisse. Croustillant de rue, format élégant.", image: "", category: "Classiques" },
  ...
  en: {
    ...
    products: [
      ...
      { id: "rua-rissois", name: "Rua Rissois", description: "Swiss meat. Street crisp, elegant format.", image: "", category: "Classics" },
